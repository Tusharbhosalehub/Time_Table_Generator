        ...
        <div id="TT" style="background-color: #FFFFFF">
            <table border="2" cellspacing="3" align="center" id="timetable">
                ...
                <tr>
                    ...
                    <td style="text-align:center">9:45-10:35</td>
                    <td style="text-align:center">10:35-11:25</td>
                    <td style="text-align:center">11:25-12:15</td>
                    <td style="text-align:center">12:15-1:05</td>
                    <td style="text-align:center">1:05-1:55</td>
                    <td style="text-align:center">1:55-2:45</td>
                    <td style="text-align:center">2:45-3:35</td>
                    <td style="text-align:center">3:35-4:25</td>
                    <td style="text-align:center">4:25-5:15</td>
                </tr>
                <tr>
                    <?php
                    $table = null;
                ...
                <td style=\"text-align:center\">LUNCH BREAK</td>  
                 <td style=\"text-align:center\">{$row['period4']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period9']}</td>
                </tr>\n";
                        }
